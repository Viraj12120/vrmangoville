...
export const ALL_GALLERY_IMAGES = [
  ...
  { image: '/story/1.png', alt: 'Bountiful Yield', description: 'A celebratory look at the season’s most vibrant Kesar harvest.', isStory: false },
  ...
  { image: '/story/2.png', alt: 'Field Selection', description: 'Every piece of fruit is inspected on the branch before harvest.', isStory: false },
  ...
  { image: '/story/3.png', alt: 'Orchard Morning', description: 'Morning dew blankets the trees, keeping the fruit fresh and hydrated.', isStory: false },
  { image: '/story/4.jpeg', alt: 'Golden Harvest', description: 'Baskets overflowing with the pride of Atpadi.', isStory: false },
  { image: '/story/4.png', alt: 'Summer Ripening', description: 'The intense summer heat develops the complex natural sugars.', isStory: false },
  { image: '/story/5.png', alt: 'Nature\'s Canopy', description: 'Dense leaf coverage protects the delicate mangoes from direct sun scorch.', isStory: false },
  ...
  { image: '/story/6.png', alt: 'Artisanal Care', description: 'Minimal intervention allows nature to express its true flavors.', isStory: false },
  { image: '/story/7.png', alt: 'Careful Packaging', description: 'Traditional wooden crates lined with straw for the perfect aeration.', isStory: false },
  ...
  { image: '/story/8.png', alt: 'Harvest Tools', description: 'Traditional tools designed to pick fruit without causing bruises.', isStory: false },
  ...
  { image: '/story/9.png', alt: 'Legacy of Trust', description: 'Built on years of delivering the absolute best to our customers.', isStory: false },
  { image: '/story/10.png', alt: 'Premium Selection', description: 'Only the top 5% of the yield is selected for our premium crates.', isStory: false },
